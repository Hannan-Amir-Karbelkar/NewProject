			...
			<div class="row col-lg-7 col-12 page2 webPages parent_listingProduct page2_content">
				<div class="MainCategeryContainer">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control category" id="category" name="category" required>
...
$(document).on('click', '.btn', function(){
	...
	$.ajax({
        ...
        type: 'post',
		data: { category:category, metaDescription:metaDescription, tagy:tagy, status:status },
